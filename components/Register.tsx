      ...
      >
        <View className="items-center mb-7">
          <View className="w-12 h-12 rounded-2xl bg-violet-600 items-center justify-center mb-3.5 shadow-lg">
            <Text className="text-white text-lg font-extrabold">B2LP</Text>
          </View>
          <Text className="text-2xl font-extrabold text-slate-900">Créer un compte</Text>
          <Text className="mt-1 text-sm text-slate-500 text-center">Rejoignez la communauté</Text>
        </View>
        ...
        <View className="w-full max-w-sm rounded-2xl border border-slate-200 bg-white p-5 gap-3.5 shadow-sm">
          ...
          >
            {loading
              ...
              : <Text className="text-sm font-bold text-white">Créer mon compte</Text>
            }
          </Pressable>
        </View>
        ...
        <View className="flex-row items-center mt-5">
          ...
          <Pressable onPress={() => router.push('/login')}>
            <Text className="text-sm font-bold text-violet-600">Se connecter</Text>
          </Pressable>
        </View>
      </ScrollView>
    </KeyboardAvoidingView>
